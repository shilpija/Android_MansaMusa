...
import com.freshhome.DriverModule.DriverOrderDetailActivity;
...
public class DriverOrderHistoryAdapter extends BaseAdapter {
    ...
    public DriverOrderHistoryAdapter(Context context, ArrayList<Orders> arrayOrder, boolean ispending) {
...
//        mViewHolder.linear_repeat.setTag(arrayOrder.get(i).getOrder_id());
        ...
        mViewHolder.linear_main.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(context, DriverOrderDetailActivity.class);
