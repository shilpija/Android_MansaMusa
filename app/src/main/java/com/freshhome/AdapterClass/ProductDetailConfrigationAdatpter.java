...
public class ProductDetailConfrigationAdatpter extends RecyclerView.Adapter<ProductDetailConfrigationAdatpter.ProductDetailsViewHolder> {
    String attribute_type;
    String currency;
    private Context context;
    private ArrayList<subAttributes> proList;
    private OnConfrigationClickListener onConfrigationClickListener;

    public ProductDetailConfrigationAdatpter(Context context, ArrayList<subAttributes> proList, OnConfrigationClickListener onConfrigationClickListener,String currency, String attribute_type) {
        this.context = context;
        this.proList = proList;
        this.currency = currency;
        this.onConfrigationClickListener = onConfrigationClickListener;
...
//            }
    ...
    public interface OnConfrigationClickListener {
        void onConfrigationClick(int position, String name, String attribute_type,boolean ischeck);
    }
        ...
        public ProductDetailsViewHolder(@NonNull View itemView) {
            ...
            radiobtn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    onConfrigationClickListener.onConfrigationClick(getAdapterPosition(), proList.get(getAdapterPosition()).getSubAttr_name(), attribute_type,checkbox.isChecked());
                }
            });
