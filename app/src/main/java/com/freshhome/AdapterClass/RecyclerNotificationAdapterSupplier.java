...
public class RecyclerNotificationAdapterSupplier extends RecyclerView.Adapter<RecyclerNotificationAdapterSupplier.MyViewHolder> {
    Context context;
    ...
    public RecyclerNotificationAdapterSupplier(Context context, ArrayList<NotificationModel> array_notification) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new RecyclerNotificationAdapterSupplier.MyViewHolder(itemView);
    }
        ...
        linear_main.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (array_notification.get(pos).getType().equalsIgnoreCase("order_delivered")
                    ...
                    i.putExtra("type", array_notification.get(pos).getOrderstatus());
                    i.putExtra("order_id", array_notification.get(pos).getOrder_id());
