...
public class SubcategoryDetailAdapter extends BaseAdapter {
    Context context;
    ArrayList<categories> arraydata;
    LayoutInflater inflater;
    ApiInterface apiInterface;

    public SubcategoryDetailAdapter(Context context, ArrayList<categories> arraydata) {
...
if(!arraydata.get(i).get_name().equalsIgnoreCase("")){
