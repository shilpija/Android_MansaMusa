...
//				imageFileUri = FileProvider.getUriForFile(TakeImage.this,BuildConfig.APPLICATION_ID + ".provider",new File(path));
			 //imageFileUri = FileProvider.getUriForFile(getApplicationContext(), "com.freshhome", new File(path));
				imageFileUri = FileProvider.getUriForFile(TakeImage.this,"com.freshhome",new File(path));
